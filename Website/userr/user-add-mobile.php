				...
				<form method="post" id="add_user">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							...
							<input type="number" class="form-control margin-bottom required" name="noHp" id="noHp" placeholder="Masukkan No.HP" pattern="[0-9]{10,13}" title="Masukkan 10-13 digit angka saja">
						</div>
						<!-- Password -->
						<div class="col-xs-6">
