...
import com.my.kasirtemeji.api.RetrofitInstance.apiService
        ...
        if (SessionManager.getInstance()?.isLoggedIn()==true) {
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Ya") { _, _ ->
                    doLogout()
                    Toast.makeText(this@MainDapur, "Logout berhasil", Toast.LENGTH_SHORT).show()
                    restartActivity()
                }
                .setNegativeButton("Tidak", null)
                .show()
        } else {
            Toast.makeText(this@MainDapur, "Anda belum login", Toast.LENGTH_SHORT).show()
        }
    }
