	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="add_user_mobile">
					<input type="hidden" name="action" value="add_user_mobile">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_add_user_mobile" class="btn btn-success float-right" value="Add user" data-loading-text="Adding...">
						</div>
					</div>
